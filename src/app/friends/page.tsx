...
import { getBlockList } from "@/actions/block";
...
export default async function FriendsPage() {
  ...
  const [friendships, blockList] = await Promise.all([
  ...
  return (
    <div className="space-y-8">
      ...
      <FriendsClientV2 userId={user.id} friendships={friendships} blockList={blockList} />
    </div>
  );
}
